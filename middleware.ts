...
// built-in crypto module directly for HMAC verification — Edge-runtime
// middleware using Web Crypto (SubtleCrypto) was found to silently not
// execute on some Vercel deployments, so this avoids that entirely.
